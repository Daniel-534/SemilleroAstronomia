...
\begin{itemize}[leftmargin=1.5em]
    ...
    \item $L$: tiempo promedio (años terrestres) durante el cual una civilización emite señales detectables.
\end{itemize}
\end{concepto}
...
Supongamos:
\[
R_* = 2,\ f_p = 0.8,\ n_e = 0.3,\ f_l = 0.3,\ f_i = 0.02,\ f_c = 0.2,\ L = 8000\ \text{años terrestres}
\]
Entonces:
\[
...
\[
R_* = 2,\ f_p = 0.8,\ n_e = 0.3,\ f_l = 0.01,\ f_i = 0.001,\ f_c = 0.1,\ L = 500\ \text{años terrestres}
\]
resulta:
\[
