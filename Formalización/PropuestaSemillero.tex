...
\begin{titlepage}
    ...
    \vspace{1cm}
    {\Huge\bfseries CENTRO DE INTERÉS: SEMILLERO DE ASTRONOMÍA\par}
    \vspace{0.5cm}
    ...
    {\large Daniel Soto \& Gerardo Ríos\par}
...
\begin{itemize}
	...
	\item Población Objetivo: Abierto a todo público, tanto estudiantes como la comunidad en general.
\end{itemize}
\section{Organización y Responsabilidades}

\begin{itemize}
    \item Asesor Principal: \textit{Daniel Soto Villada}. Director Académico
    \item Co-asesor: \textit{Gerardo Ríos}: Director  de Gestión
...
\rule{8cm}{0.4pt}\\
\textbf{Daniel Soto \& Gerardo Ríos}\\
